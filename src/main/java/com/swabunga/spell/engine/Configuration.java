...
public abstract class Configuration {
    ...
    // public static final String EDIT_SIMILAR = "EDIT_SIMILAR"; //DMV: these
    ...
    /**
     * words that are all upper case are not spell checked, example: "CIA" <br/>
     * (boolean)
     */
    public static final String SPELL_IGNOREUPPERCASE = "SPELL_IGNOREUPPERCASE";
    /**
     * words that have mixed case are not spell checked, example: "SpellChecker"<br/>
     * (boolean)
     */
    ...
    /**
     * words that have digits in them are not spell checked, example: "mach5" <br/>
     * (boolean)
     */
    public static final String SPELL_IGNOREDIGITWORDS = "SPELL_IGNOREDIGITWORDS";
    /**
     * I don't know what this does. It doesn't seem to be used <br/>
     * (boolean)
     */
