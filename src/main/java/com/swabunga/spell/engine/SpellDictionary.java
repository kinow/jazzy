...
public interface SpellDictionary {
     ...
     * spellings. <br/>
     * Each suggested word has a score, which is an integer that represents how
     * different the suggested word is from the sourceWord. If the words are the
     * exactly the same, then the score is 0. You can get the dictionary to only
     * return the most similar words by setting an appropriately low threshold
     * value. If you set the threshold value too low, you may get no suggestions
     * for a given word.
     * <p>
     ...
     * 
     * @param sourceWord the string that we want to get a list of spelling
     *            suggestions for
     * @param scoreThreshold Any words that have score less than this number are
     *            returned.
     ...
     * @param scoreThreshold Any words that have score less than this number are
     *            returned.
     * @param Two dimensional int array used to calculate edit distance.
