...
public class GenericSpellDictionary extends SpellDictionaryASpell {
    ...
    // since they are so closely tied to how the phonetic transformations are
    // done.
    // /**
    ...
    /**
     * Dictionary constructor that uses the DoubleMeta class with the English
     * alphabet.
     * 
     ...
     *             list file
     */
    public GenericSpellDictionary(File wordList) throws FileNotFoundException,
            IOException {
