 ...
 * dictionary files, see: <a href="http://wordlist.sourceforge.net/">
 * http://wordlist.sourceforge.net/</a>
 * <p/>
 * You can choose words lists form <a href="http://aspell.net/">aspell</a> many
 * differents languages dictionaries. To grab some, install <code>aspell</code>
...
public abstract class SpellDictionaryASpell implements SpellDictionary {
     ...
     *            list. If <code>phonetic</code> is null, the the transformation
     ...
     *            words list. If <code>phonetic</code> is null, the the
    ...
    public List<Word> getSuggestions(String word, int threshold, int[][] matrix) {
        ...
        Map<String, String> nearmisscodes = new HashMap<String, String>();
        ...
        // interchange
        nearmisscodes = new HashMap<String, String>();
     ...
     */
//    private void addBestGuess(String word, List<Word> wordList) {
...
//    }
    ...
    private List<Word> getWordsFromCode(String word, Map<String, String> codes) {
        ...
        Iterator<Map.Entry<String, String>> it = codes.entrySet().iterator();
        while (it.hasNext()) {
