 ...
 * 
 * <p>
 * It also allows for the string to be altered by calls to replaceWord(). The
...
public class StringWordTokenizer extends AbstractWordTokenizer {
     ...
     * Creates a new StringWordTokenizer object.
     * 
     * @param wf the custom WordFinder to use in tokenizing. Note that the
     ...
     * @param finder the custom WordFinder to use in tokenizing. Note that the
     *            string to tokenize will be encapsulated within the WordFinder.
     */
    ...
    /**
     * 
     * @deprecated use getContext() instead as per the WordTokenizer interface
     *             specification.
