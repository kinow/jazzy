...
/**
 * <p>
 * An interface for objects which take a text-based media as input, and iterate
 * through the words in the text stored in that media. Examples of such media
 * could be Strings, Documents, Files, TextComponents etc.
 * </P>
 * 
 * <P>
 * When the object is instantiated, and before the first call to
 ...
 * 
 * <P>
 * A call to <CODE>next()</CODE> when <CODE>hasMoreWords()</CODE> returns false
 * should throw a <CODE>WordNotFoundException</CODE>.
 * </P>
 * 
