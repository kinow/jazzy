...
public abstract class AbstractWordFinder implements WordFinder {
     ...
     * it contains the <code>startIgnore</code>, and until the first non letter
     * or digit character is encountered or end of text is detected.
     * 
     ...
     *            the value of endIgnore is <code>null</code>, skipping
     *            characters stop at first non letter or digit character.
     * @return The index position pointing after the skipped characters or the
     *         original index if the ignore condition could not be met.
     */
    ...
    /**
     * Ignores or skip over text starting from the index position specified if
     * it contains the <code>startIgnore</code> string, and until the
