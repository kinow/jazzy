 ...
 * SpellCheckListeners
 * <p/>
 * As far as I know, we will only require one implementation of the
 * SpellCheckEvent (BasicSpellCheckEvent) but I have defined this interface just
 * in case. The BasicSpellCheckEvent implementation is currently package
 * private.
 * 
